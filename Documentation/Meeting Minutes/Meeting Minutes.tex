...
\author{Janice Chin \\ Supervisor: David Pearce}
\date{}
\begin{document}
...
\subsection{Action points were achieved since the last meeting}
Review of the final version of changes!
(\href{https://gitlab.ecs.vuw.ac.nz/project489-2018/chinjani/quickcheck-for-whiley-final-report/blob/master/Draft%20V8%20QuickCheck%20for%20Whiley%20-%20Janice%20Chin.pdf}{Draft QC for Whiley V8}). 
\subsection{Action points have yet to be achieved since the last meeting}
\subsection{Action points were agreed to for the next meeting}

\subsection{Notes}
\begin{itemize}
	\item Just minor typos and fixes.
\end{itemize}
