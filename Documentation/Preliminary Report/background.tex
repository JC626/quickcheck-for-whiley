...
% TODO explain what QC does with integer values
...
% TODO add example of CUTE with the above paragraph
...
This list of method sequences throws an error as the \texttt{equals()} method is incorrect and thus, is a contract-violating test that will be outputted.
