...
Below is an example of a Whiley program with a function,  \texttt{min()} which finds the minimum value of two integers. This program prints out "The smallest integer is 3" when executed. 

\begin{minipage}{\linewidth}
\begin{lstlisting}[tabsize=3, numbers=left,
 caption= Whiley program for the min function \label{lst:min}]
import std::io
import std::ascii
...
method main():
	...
	io::print("The smallest integer is ")
	io::println(smallest)
