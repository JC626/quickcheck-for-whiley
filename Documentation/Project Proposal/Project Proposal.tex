...
However, writing and running tests can be tedious and costly. Furthermore, it is difficult to write tests for all possible cases therefore, obscure bugs may not be detected. 
...
Input values that adhere to the function's preconditions will be used in testing. 
...
\begin{tabular}{ |p{10cm}|p{2cm}|p{2cm}|p{2cm}| }
	...
	\hline
	Implement an automated test-case generator for Whiley programs with only the types: bool, byte, int, null & 3 weeks & 19/3/18 & 16/4/18 (Week 6) \\
